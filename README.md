...
| **Nike SWE in 48** (target kit) | One real JD — Senior SWE, Nike India Technology Centre — decoded line by line: 12 topics across Node, serverless AWS (Lambda · Step Functions · DynamoDB · OpenSearch · S3), IaC/CI-CD, API-first, testing, CSS architecture, Vue-for-React-engineers, AI integration; 120 Q&As with answers, a 5-round mock interview circuit with rubric, prep plans, cheat tables. Independent kit, not affiliated with Nike | [/nike-sde](https://dsa-in-48.vercel.app/nike-sde) · [GitHub Pages](https://rajkaria.github.io/dsa-in-48/nike-sde.html) |
